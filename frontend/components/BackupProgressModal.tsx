/**
 * Backup Download Progress Modal
 * Shows download progress when downloading a backup file from the server
 */
      ...
      <div className="bg-gray-800 rounded-lg shadow-2xl max-w-lg w-full">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            {progress.current > 0 && (
              <div className="bg-gray-700/50 rounded-lg p-4">
                <div className="text-gray-400 text-sm mb-1">Downloaded</div>
                <div className="text-xl font-bold text-white">
